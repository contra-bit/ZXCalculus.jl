...
@testset "Split Vertex fail" begin
    pmg1 = PlanarMultigraph(
        Dict(1 => 1, 2 => 2),
        Dict(1 => HalfEdge(1, 2), 2 => HalfEdge(2, 1), 3 => HalfEdge(1, 2), 4 => HalfEdge(2, 1)),
        Dict(1 => 1, 0 => 2),
    ...
    @test_throws "Should use #TODO to add multiedge and split facet!" split_facet!(pmg1, 1, 4)
end
...
@testset "Join/Split Vertex" begin
    ...
    pmg2 = PlanarMultigraph(
        ...
        Dict(1 => 9, 9 => 3, 3 => 4, 4 => 5, 5 => 6, 6 => 10, 10 => 7, 7 => 8, 8 => 2, 2 => 1),
        Dict(1 => 2, 2 => 1, 3 => 4, 4 => 3, 5 => 6, 6 => 5, 7 => 8, 8 => 7, 9 => 10, 10 => 9),
        6,
        10,
        0,
        [0],
...
@testset "Split Edge" begin
    pmg1 = PlanarMultigraph(
        Dict(1 => 1, 2 => 3, 3 => 4),
        Dict(1 => HalfEdge(1, 2), 2 => HalfEdge(2, 1), 3 => HalfEdge(2, 3), 4 => HalfEdge(3, 2)),
        Dict(0 => 1),
...
@testset "Simple Quantum Circuit Creation Operations" begin
    ...
    pmg2 = PlanarMultigraph(
        ...
        Dict(0 => 1, 1 => 2),
        Dict(1 => 0, 2 => 1, 3 => 0, 4 => 1, 5 => 0, 6 => 1, 7 => 1, 8 => 0, 9 => 0, 10 => 1),
        Dict(1 => 9, 9 => 3, 3 => 5, 5 => 8, 8 => 1, 2 => 7, 7 => 6, 6 => 4, 4 => 10, 10 => 2),
        Dict(1 => 2, 2 => 1, 3 => 4, 4 => 3, 5 => 6, 6 => 5, 7 => 8, 8 => 7, 9 => 10, 10 => 9),
        5,
        10,
        1,
...
@testset "Add Facet and Vertex to Boarder" begin
    ...
    pmg2 = PlanarMultigraph(
        ...
        Dict(0 => 1, 1 => 3),
        Dict(1 => 0, 2 => 0, 3 => 1, 4 => 0, 5 => 0, 6 => 0, 7 => 0, 8 => 1, 9 => 1, 10 => 0),
        Dict(1 => 7, 7 => 10, 10 => 5, 5 => 6, 6 => 4, 4 => 2, 2 => 1, 8 => 3, 3 => 9, 9 => 8),
        Dict(1 => 2, 2 => 1, 3 => 4, 4 => 3, 5 => 6, 6 => 5, 7 => 8, 8 => 7, 9 => 10, 10 => 9),
        5,
        10,
        1,
